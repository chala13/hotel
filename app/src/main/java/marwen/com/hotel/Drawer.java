...
public class Drawer extends AppCompatActivity {
    ...
    private void initInstances() {
        ...
        drawerToggle = new ActionBarDrawerToggle(Drawer.this, drawerLayout, R.string.hello_world, R.string.hello_world);
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                switch (id) {
                    ...
                    case R.id.navigation_item_3:
                        startActivity(new Intent(Drawer.this,Chambres.class));
                        break;
                    case R.id.navigation_item_11:
                        startActivity(new Intent(Drawer.this,Reunions.class));
                        break;
                    case R.id.navigation_item_4:
                        startActivity(new Intent(Drawer.this,Gallerie.class));
                        break;
